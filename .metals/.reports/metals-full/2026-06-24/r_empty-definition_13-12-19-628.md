error id: file://<WORKSPACE>/spark_scala/spark_scala/src/main/scala/com/lakehouse/ProcessData.scala:
...
object ProcessData {
    def main(args: Array[String]): Unit ={
        ...
        val readDf = spark.read.format("iceberg").load(t@@ableName)
        readDf.show(5)
